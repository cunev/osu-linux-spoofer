/*** Autogenerated by WIDL 7.0 from ../wine-osu/include/windows.devices.enumeration.idl - Do not edit ***/
...
DEFINE_GUID(IID___FIMapView_2_HSTRING_IInspectable, 0x8148407c, 0x4c5b, 0x5be5, 0xb5,0xdd, 0x1e,0x8d,0x82,0x3b,0xfb,0xd9);
#if defined(__cplusplus) && !defined(CINTERFACE)
} /* extern "C" */
namespace ABI {
    namespace Windows {
        namespace Foundation {
            namespace Collections {
                template<>
                MIDL_INTERFACE("8148407c-4c5b-5be5-b5dd-1e8d823bfbd9")
...
extern "C" {
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(__FIMapView_2_HSTRING_IInspectable, 0x8148407c, 0x4c5b, 0x5be5, 0xb5,0xdd, 0x1e,0x8d,0x82,0x3b,0xfb,0xd9)
#endif
#else
